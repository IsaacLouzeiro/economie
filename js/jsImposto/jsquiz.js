var questions = [{
	...
	choices: ["O Imposto é um tributo obrigatório cobrado pelo governo. Isso quer dizer que é um valor que você paga e contribui para custear as despesas administrativas do Estado.", "Uma taxa de juros cobrada mensalmente em cima dos imposto mensais", "Imposto cobrado em cima da sua renda mensal "],
	correctAnswer: 0
}, {
	tamanhoPorcento: "20%",
	numQuestao: "2/10",
	numQuestao2: "Questão 2",
	question: "O que é taxas de tributos?",
	choices: ["são juros em cima de compras que você fez", "Taxa é um beneficio em cima da sua renda salarial", "A taxa é uma espécie tributária cuja cobrança é vinculada a uma atuação estatal"],
	correctAnswer: 2
}, {
	tamanhoPorcento: "30%",
	numQuestao: "3/10",
	numQuestao2: "Questão 3",
	question: "O que é Tributo federal?",
	choices: ["Tudo que ganhei no mês", " um tributo é toda prestação pecuniária compulsória","Tributos é todo valor que pago mensal"],
	correctAnswer: 1
}, {
	tamanhoPorcento: "40%",
	numQuestao: "4/10",
	numQuestao2: "Questão 4",
	question: "O IPVA é um imposto referido a qual tipo de propriedade?",
	choices: ["Nome técnico para imposto de água", "Propriedade residencial ", "Veiculos motorizados"],
	correctAnswer: 2
}, {
	tamanhoPorcento: "50%",
	numQuestao: "5/10",
	...
	question: "Imposto federal serve para quê?",
	choices: ["Para manter funcionalidade dos serviços públicos e coletivos","Para manter seus bens", "Para te deixar rico"],
	correctAnswer: 0
	...
	question: "Qual o Imposto sobre Circulação de Mercadorias?",
	choices: ["IPVA", "ICMS", "FGTS"],
	correctAnswer: 1
}, {
	tamanhoPorcento: "80%",
	numQuestao: "8/10",
	numQuestao2: "Questão 8",
	question: "O IPTU é um imposto referido a qual tipo de propriedade?",
	choices: ["Veículos motorizados","Propriedade Predial e Territorial Urbana"],
	correctAnswer: 1
}, {
	tamanhoPorcento: "90%",
	numQuestao: "9/10",
	numQuestao2: "Questão 9",
	question: "Qual o significado da sigla INSS?",
	choices: ["Instituto nacional de Seguro Social ", "Instituição Nacional de segurança", "instituto nacional de seguro ao aposentado"],
	correctAnswer: 0
	...
	question: "O que é rendimento tributável?",
	choices: ["É rendimento de todas as pessoas da casa", "Os rendimentos tributáveis são os rendimentos que independente de suas origens, estão propensas a sofrer tributações.", "Os rendimentos tributáveis necessariamente sofrem tributações que dependem da validade de suas origens e destinos."],
	correctAnswer: 1
