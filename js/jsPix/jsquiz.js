var questions = [{
	...
	question: "Por que PIX é tão inovador?",
	choices: ["Porque as transações de dinheiro flui melhor", "Porque é gratuito", "Porque é mais rápido"],
	correctAnswer: 0
}, {
	tamanhoPorcento: "20%",
	numQuestao: "2/10",
	numQuestao2: "Questão 2",
	question: "O PIX serve apenas pra transferência?",
	choices: ["Sim", "Não"],
	correctAnswer: 0
}, {
	tamanhoPorcento: "30%",
	...
	question: "Qual valor limite de uma transação de PIX?",
	choices: ["6 mil reais por dia", "5 mil reais por dia", "10 mil reais por dia"],
	correctAnswer: 1
}, {
	tamanhoPorcento: "40%",
	numQuestao: "4/10",
	numQuestao2: "Questão 4",
	question: "Qual é tempo de uma transação de PIX?",
	choices: ["24 horas", "40 segundos", "3 a 4 horas"],
	correctAnswer: 1
}, {
	tamanhoPorcento: "50%",
	numQuestao: "5/10",
	numQuestao2: "Questão 5",
	question: "PIX tem custo para fazer uma transação?",
	choices: ["Sim, 5 reais", "Não, é gratuito", "Sim, 1 real", "Ele tem limite de 3 PIX por dia depois disso fica pago"],
	correctAnswer: 1
}, {
	tamanhoPorcento: "60%",
	numQuestao: "6/10",
	numQuestao2: "Questão 6",
	question: "De qual forma pode ser feito um PIX? Quais chaves?",
	choices: ["CPF, e-mail, telefone e chave aleatória", "CPF e e-mail", "CPF, telefone e e-mail"],
	correctAnswer: 0
	...
	question: "Qual limite de chaves 1 usuário pode ter?",
	choices: ["6 chaves para cada conta", "8 chaves para cada conta","20 chaves para cada conta","4 chaves para cada conta"],
	correctAnswer: 3
}, {
	tamanhoPorcento: "80%",
	numQuestao: "8/10",
	numQuestao2: "Questão 8",
	question: "Posso pagar qualquer coisa com PIX?",
	choices: ["Sim, desde que a pessoa aceite receber uma transferência  PIX", "Não, pois o PIX é so pra transferência", "Sim, é so passar cartão"],
	correctAnswer: 0
}, {
	tamanhoPorcento: "90%",
	numQuestao: "9/10",
	numQuestao2: "Questão 9",
	question: "Preciso ter conta em banco para receber PIX?",
	choices: ["Sim, pois é por la que eu cadastro as chaves", "Não,so preciso das chaves"],
	correctAnswer: 0
	...
	question: "É possível fazer cancelamento de um pix?",
	choices: ["Sim em todas as situações", "Não é possivel", "Sim, depende da situação"],
	correctAnswer: 1
